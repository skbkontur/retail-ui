...
- `yarn workspace react-ui-screenshot-tests <command>` — скриншотные тесты
  ...
  - `test:update` - approve все новых/сломанных скриншотов
...
- build: изменения в системе соборки или внешних зависимостях
...
Все три поля в сумме состовляют заголовок комита, который не должен превышать **72 символа**. Более подробное описание можно оставить в теле коммита, отступив одну пустую строку от заголовка. Например:
