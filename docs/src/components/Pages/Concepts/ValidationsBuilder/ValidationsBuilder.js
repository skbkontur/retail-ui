    ...
    render(): React.Element<*> {
        return (
            <div>
                ...
                <p>
                    Интерфейс библиотеки устроен так, что валиадции можно делать внешними по отношению к
                ...
                <p>
                    ...
                    очень громоздким и нечитаемым. Для этого можно использовать контсруктор валидаций.
                    В итоге код можнет выглядеть такие образом:
                </p>
                <Code>{`
