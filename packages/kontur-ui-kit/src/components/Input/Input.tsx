...
import { InputLeftIcon, InputRightIcon, InputStyledView, InputWrapper } from './InputView';
...
class Input extends React.Component<InputProps, InputState> {
  ...
  private renderPlaceholder() {
    ...
    if (this.state.polyfillPlaceholder && this.props.placeholder && !this.props.value) {
      placeholder = (
        <div style={{ textAlign: this.props.align || 'inherit' }}>{this.props.placeholder}</div>
      );
    }
