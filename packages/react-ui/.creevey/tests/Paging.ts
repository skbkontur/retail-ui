  ...
  describe('GoToAbsensePage', function() {
    ...
    it.skip(['ie11'], 'hover', async function() {
      ...
      await this.browser
        ...
        .move({
          origin: this.browser.findElement(By.css(`[data-tid='Paging__pageLinkWrapper']`)),
        })
        .perform();
    ...
    it('change page by number', async function() {
      ...
      await this.browser
        ...
        .click(this.browser.findElement(By.css(`[data-tid='Paging__pageLinkWrapper']`)))
        .perform();
    ...
    it('change page by forwardLink', async function() {
      ...
      await this.browser
        ...
        .click(this.browser.findElement(By.css(`[data-tid='Paging__forwardLink']`)))
        .perform();
