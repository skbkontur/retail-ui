...
Использовать определенную промежуточную версию темы можно неограниченно долго в рамках одной мажорной версии библиотеки. Но в момент выхода очередного мажора все промежуточные версии тем и их тесты удаляются. Таким образом, при миграции на новый мажор придется применить все отложенные до этого визуальные изменения.
