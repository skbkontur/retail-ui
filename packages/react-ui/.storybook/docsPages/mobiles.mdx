...
Так же можно передавать свои медиазапросы в хук `useResponsiveLayout` или через проп `options` в [ResponsiveLayout](?path=/docs/layout-responsivelayout--docs).
...
Как альтернативу можно использовать отдельный компонент [ResponsiveLayout](?path=/docs/layout-responsivelayout--docs).
