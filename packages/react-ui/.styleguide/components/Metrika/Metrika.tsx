...
export function SectionHeadingRenderer({ classes, children, toolbar, id, href, depth, deprecated }) {
  window.infra_frontTracker.trackPageVisit(children);

  return (
    <div>
      <DefaultSectionHeadingRenderer id={id} href={href} depth={depth} deprecated={deprecated}>
        {children}
