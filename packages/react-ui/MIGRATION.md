...
| `DARK_THEME`        | Темная               |
| `DEFAULT_THEME_8PX` | Предыдущая дефолтная |
| `FLAT_THEME_8PX`    | Предыдущая плоская   |
