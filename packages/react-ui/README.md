...
О том как подключить шрифт можно прочитать в [Гайдах](https://guides.kontur.ru/principles/text-styles/#Shrift). Для доступа к гайду нужно авторизоваться на сайте гайдов (кнопка находится в самом низу страницы)
