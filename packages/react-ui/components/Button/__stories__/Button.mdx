...
<Canvas>
  <Gapped>
    <Button width={150} loading={true}>Удалить</Button>
    <Button icon={<MinusCircleIcon16Light />} width={150} loading={true}>Удалить</Button>
    <Button rightIcon={<MinusCircleIcon16Light />} width={150} loading={true}>Удалить</Button>
    <Button icon={<MinusCircleIcon16Light />} rightIcon={<MinusCircleIcon16Light />} width={150} loading={true}>Удалить</Button>
  </Gapped>
</Canvas>
