...
import { getInitialDate } from '../../components/Calendar/calendarHelpers';
...
type DefaultProps = Required<
  Pick<CalendarProps, 'minDate' | 'maxDate' | 'hasBottomSeparator' | 'shouldSetInitialDate'>
>;
...
export class Calendar extends React.Component<CalendarProps, CalendarState> {
  ...
  public static defaultProps: DefaultProps = {
    ...
    hasBottomSeparator: false, // hasBottomSeparator={!_isDatePicker}
    shouldSetInitialDate: false, // shouldSetInitialDate={!_isDatePicker}
  };
  ...
  constructor(props: CalendarProps) {
    ...
    const date = getInitialDate(today, this.props.value, this.props.minDate, this.props.maxDate);

    let initialMonth = props._initialMonth ?? today.month;
    let initialYear = props._initialYear ?? today.year;
    if (this.props.shouldSetInitialDate && date) {
  ...
  /**
   * Позволяет проскроллить календарь до указанной даты
   * @public
   */
    ...
    return (
      <>
        <div
          ...
          className={cx(styles.root(this.theme), this.props.className)}
        >
          <div>
