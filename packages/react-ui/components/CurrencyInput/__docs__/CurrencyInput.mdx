...
Если вам нужно отобразить в интерфейсе просто денежную сумму, не включая её в поле ввода, используйте [CurrencyLabel](https://tech.skbkontur.ru/kontur-ui/?path=/docs/react-ui_display-data-currencylabel--docs).
