...
describe('DatePicker', () => {
  ...
  it('onMonthChange returns correct year', async () => {
    ...
    userEvent.click(screen.getByTestId(DatePickerDataTids.input));
    userEvent.click(screen.getByTestId(CalendarDataTids.headerYear).getElementsByTagName('button')[0]);
    userEvent.click(screen.getByText('2018').parentElement as Element);
