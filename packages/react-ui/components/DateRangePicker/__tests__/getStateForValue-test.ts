...
describe('DateRangePicker value pick', () => {
  ...
  it(`should set value to 2nd field, save focus in 2nd and close picker`, () => {
    expect(
  ...
  it(`should set value to 2nd field, preserve save focus in 2nd and close picker`, () => {
    expect(
  ...
  it(`should preserve equal value in 2nd field, save focus in 2nd and close picker`, () => {
    expect(
      getStateForValue('end', '15.10.2000', {
        currentStart: '10.10.2000',
  ...
  it(`should set equally value to 2nd field, save focus in 2nd and close picker`, () => {
    expect(
  ...
  it(`should set equally value to 1st field, save focus in 1st and close picker`, () => {
    expect(
      getStateForValue('start', '10.10.2000', {
        currentStart: '10.10.2000',
  ...
  it(`should set value to 1st field, save focus in 1st and close picker`, () => {
    expect(
      getStateForValue('start', '10.10.2000', {
        currentStart: '10.10.2000',
        currentEnd: '10.10.2000',
  ...
  it(`should save state when 1st value < minDate`, () => {
    expect(
  ...
  it(`should save state when if 2nd value > maxDate`, () => {
    expect(
