...
WithFixedWidth.story = {
  ...
  parameters: { creevey: { captureElement: '.dropdown-test-container' } },
};
...
WithOverflow.story = { name: 'With overflow', parameters: { creevey: { captureElement: '.dropdown-test-container' } } };
...
WithIcon.story = { name: 'With icon', parameters: { creevey: { captureElement: '.dropdown-test-container' } } };
...
WithMenuItemIcon.story = {
  name: 'With MenuItem icon',
  parameters: {
    creevey: {
...
WithIconAndOverflow.story = {
  name: 'With icon and overflow',
  parameters: { creevey: { captureElement: '.dropdown-test-container' } },
};
