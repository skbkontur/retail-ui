import * as GlobalLoaderStories from './GlobalLoader.stories.tsx';
import { Meta, Primary, Controls, Canvas } from '@storybook/blocks';
import { GlobalLoader } from '../GlobalLoader';
import { Button, Toggle, Gapped, ThemeContext, ThemeFactory, Modal } from '@skbkontur/react-ui';
...
Глобальный Лоадер может быть только один в приложении. Поэтому, каждый новый экземпляр компонента "убивает" предыдущий
