...
type InputState = Partial<MaskedInputV2Props>;
...
const [propsPreset, propsSetA, propsSetB]: [
  MaskedInputV2Props,
  Array<Partial<MaskedInputV2Props>>,
  Array<Partial<MaskedInputV2Props>>,
] = [
...
const testPropsSets: MaskedInputV2Props[] = [];
...
export const CompareWithInput: Story = () => {
  const Comp = ({ comp, ...props }: { comp: 'MaskedInputV2' | 'Input-mask' | 'Input' } & MaskedInputV2Props) => {
    const [value, setValue] = useState(props.value);

    if (comp === 'MaskedInputV2') {
      return <MaskedInputV2 {...({ ...props, value } as MaskedInputV2Props)} onValueChange={setValue} />;
    }
    if (comp === 'Input-mask') {
  ...
  return (
    <ComponentTable<any, any, any>
      Component={Comp}
      cols={[{ comp: 'MaskedInputV2' }, { comp: 'Input-mask' }, { comp: 'Input' }].map((x) => ({ props: x }))}
...
const DEFAULT_PROPS: MaskedInputV2Props = {
...
export const Default: Story = () => {
  ...
  return <MaskedInputV2 {...DEFAULT_PROPS} value={value} onValueChange={setValue} />;
};

export const IdleFocusEditBlurWithPlaceholder: Story = () => {
  const [value, setValue] = React.useState<string>();
  return <MaskedInputV2 {...DEFAULT_PROPS} placeholder="Телефон" value={value} onValueChange={setValue} />;
};
...
export const IdleFocusBlurWithPrefix: Story = () => {
  const [value, setValue] = React.useState<string>();
  return (
    <MaskedInputV2 {...DEFAULT_PROPS} mask="999 999-99-99" prefix="+7&nbsp;" value={value} onValueChange={setValue} />
  );
};
...
export const IdleFocusBlurAndUncontrolled: Story = () => <MaskedInputV2 {...DEFAULT_PROPS} />;
...
export const IdleFocusBlurAndUncontrolledWithDefaultValue: Story = () => (
  <>
    ...
    <br />
    <MaskedInputV2 {...DEFAULT_PROPS} defaultValue="+7 123" />
    <br />
    <br />
    <span>
    ...
    <br />
    <MaskedInputV2 {...DEFAULT_PROPS} defaultValue="123" />
    <br />
    <br />
    <span>Самый простой способ обойти проблему - всегда показывать маску.</span>
    <br />
    <MaskedInputV2 {...DEFAULT_PROPS} defaultValue="+7 123" alwaysShowMask />
  </>
);
...
export const RewriteInMiddle: Story = () => {
  ...
  return <MaskedInputV2 {...DEFAULT_PROPS} mask="9999" alwaysShowMask value={value} onValueChange={setValue} />;
};
...
export const ChangeTheme: Story = () => {
  ...
  return (
    <ThemeContext.Provider value={theme}>
      <MaskedInputV2 {...DEFAULT_PROPS} alwaysShowMask value="123" />
