...
export interface ModalProps
  ...
  noClose?: boolean;
  width?: number | string;
  /** Вызывается, когда пользователь запросил закрытие окна (нажал на фон, на Escape или на крестик). */
  onClose?: () => void;
  /** Не использовать фокус-лок внутри модалки. По умолчанию true для IE11. */
