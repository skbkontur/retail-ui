...
const notSelectable: React.ReactElement = (
  <span id="notSelectable">Not Selectable</span>
);

export const WithNotSelectableValue: CSFStory<JSX.Element> = () => (
  <Select width="150px" items={[Select.static(() => <Select.Item>{notSelectable}</Select.Item>), 'oneoneone', 'threethree']}/>
);
