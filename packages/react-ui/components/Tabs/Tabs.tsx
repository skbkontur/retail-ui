 ...
 * Не используйте `Tabs` для переключения состояний — для этого есть [`Radio`](?path=/docs/choose-radiogroup--docs), [`Toggle`](?path=/docs/choose-toggle--docs) и [`Switcher`](?path=/docs/choose-switcher--docs).
 */
@rootNode
