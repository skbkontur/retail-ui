 ...
 *
 * Оно похоже на [`Combobox`](?path=/docs/input-elements-combobox--combobox), но используется в случаях, когда нужно указать сразу много однородных элементов — токенов.
 *
