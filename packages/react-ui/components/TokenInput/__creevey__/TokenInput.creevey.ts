...
kind("TokenInput", () => {
  story("EmptyWithReference", ({ setStoryParameters }) => {
    setStoryParameters({ captureElement: ".tokens-test-container" });
    ...
    test("clicked", async function () {
      await this.browser
        ...
        .click(
          this.browser.findElement({ css: '[data-comp-name~="TokenInput"]' })
        )
        .perform();
  ...
  story("CombinedFilled", () => {
    ...
    test("editToken", async function () {
      await this.browser
        ...
        .doubleClick(
          this.browser.findElement({ css: '[data-comp-name~="Token"]' })
        )
        .perform();
      ...
      await this.browser
        ...
        .click(
          this.browser.findElement({ css: '[data-comp-name~="MenuItem"]' })
        )
        .perform();
