...
kind("Tooltip", () => {
  ...
  story(
    "TooltipsWithoutWrapperAroundInlineBlockWith50Width",
    ({ setStoryParameters }) => {
      setStoryParameters({
        skip: {
  ...
  story("TooltipWithExternalDynamicContent", () => {
    ...
    test("02 - changes top position if does not fit", async function () {
      ...
      await delay(1000);
      await this.expect(await this.takeScreenshot()).to.matchImage(
        "02 - changes top position if does not fit"
      );
    });
    ...
    test("03 - does not change position back on shrink", async function () {
      ...
      await delay(1000);
      await this.expect(await this.takeScreenshot()).to.matchImage(
        "03 - does not change position back on shrink"
      );
    });
    ...
    test("04 - does not change top position if fits", async function () {
      ...
      await delay(1000);
      await this.expect(await this.takeScreenshot()).to.matchImage(
        "04 - does not change top position if fits"
      );
    });
    ...
    test("05 - does not change position on shrink", async function () {
      ...
      await delay(1000);
      await this.expect(await this.takeScreenshot()).to.matchImage(
        "05 - does not change position on shrink"
      );
    });
    ...
    test("06 - changes left position if does not fit", async function () {
      ...
      await delay(1000);
      await this.expect(await this.takeScreenshot()).to.matchImage(
        "06 - changes left position if does not fit"
      );
    });
    ...
    test("07 - does not change position back on shrink", async function () {
      ...
      await delay(1000);
      await this.expect(await this.takeScreenshot()).to.matchImage(
        "07 - does not change position back on shrink"
      );
    });
    ...
    test("08 - does not change bottom position if fits", async function () {
      ...
      await delay(1000);
      await this.expect(await this.takeScreenshot()).to.matchImage(
        "08 - does not change bottom position if fits"
      );
    });
    ...
    test("09 - does not change position on shrink", async function () {
      ...
      await delay(1000);
      await this.expect(await this.takeScreenshot()).to.matchImage(
        "09 - does not change position on shrink"
      );
    });
    ...
    test("11 - does not change position on shrink", async function () {
      ...
      await delay(1000);
      await this.expect(await this.takeScreenshot()).to.matchImage(
        "11 - does not change position on shrink"
      );
    });
  });
    ...
    setStoryParameters({
      skip: {
        ...
        "story-skip-0": {
          in: ["chrome8px", "chromeFlat8px", "chrome", "chromeDark"],
          tests: [
            "render in available position",
            "relocate on new available position",
          ],
        },
      },
    });
      ...
      await this.browser
        ...
        .move({
          origin: this.browser.findElement({
            css: '[data-tid~="tooltip_anchor_1"]',
          }),
        })
        .perform();
      await delay(1000);
      await this.expect(await this.takeScreenshot()).to.matchImage(
        "hover by dynamic anchor"
      );
    });
  });
});
