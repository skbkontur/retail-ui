...
TooltipWithInputAndSwitchableContent.parameters = {
  creevey: {
    skip: [{ in: ['firefox'], tests: 'focus and types' }],
    tests: {
...
DynamicTriggersStory.parameters = {
  creevey: {
    ...
    skip: [
      { in: ['ie11', 'ie118px'], tests: ['hover - mouseEnter', 'hover&focus - mouseEnter'] },
      // TODO @Khlutkova fix after update browsers
      {
        in: ['chrome', 'chrome8px', 'chromeFlat', 'chromeFlat8px'],
        tests: [
          'hover - mouseEnter',
          'click - click anchor',
          'focus - focus',
...
TooltipWithAnchor.parameters = {
  creevey: {
    skip: [
      { in: ['ie11', 'ie11Flat', 'ie118px', 'ie11Flat8px'] },
      // TODO @Khlutkova fix after update browsers
      { in: ['chrome', 'chrome8px', 'chromeFlat', 'chromeFlat8px'], tests: ['hover by dynamic anchor'] },
    ],
    tests: {
