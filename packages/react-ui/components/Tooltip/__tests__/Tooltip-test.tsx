...
describe('Tooltip', () => {
  ...
  describe('test getPosAndPositions method', () => {
    it('flag, no allowedPositions, no pos', () => {
      ...
      tooltip.featureFlags = { popupUnifyPositioning: true };
    ...
    it('no flag, no allowedPositions, no pos', () => {
      ...
      const positions = tooltip.getPositions();
      expect(positions).toEqual(Tooltip.oldDefaultAllowedPositions);
    });
    ...
    it('flag, allowedPositions, no pos', () => {
      const tooltip = new Tooltip({ allowedPositions: ['top', 'top right', 'bottom right'] });
      tooltip.featureFlags = { popupUnifyPositioning: true };
      const positions = tooltip.getPositions();
    ...
    it('flag, allowedPositions, first pos', () => {
      const tooltip = new Tooltip({ allowedPositions: ['top', 'top right', 'bottom right'], pos: 'top' });
      tooltip.featureFlags = { popupUnifyPositioning: true };
      const positions = tooltip.getPositions();
      expect(positions).toEqual(['top', 'top right', 'bottom right']);
    });
    ...
    it('flag, allowedPositions, equal pos', () => {
      const tooltip = new Tooltip({ allowedPositions: ['bottom right'], pos: 'bottom right' });
      tooltip.featureFlags = { popupUnifyPositioning: true };
      const positions = tooltip.getPositions();
    ...
    it('flag, allowedPositions, not first pos', () => {
      const tooltip = new Tooltip({ allowedPositions: ['top', 'top right', 'bottom right'], pos: 'top right' });
      tooltip.featureFlags = { popupUnifyPositioning: true };
      const positions = tooltip.getPositions();
      expect(positions).toEqual(['top', 'top right', 'bottom right']);
    });
    it('no flag, allowedPositions, not first pos', () => {
      ...
      tooltip.featureFlags = { popupUnifyPositioning: false };
      const positions = tooltip.getPositions();
      expect(positions).toEqual(['top right', 'bottom right', 'top']);
    });

    it('flag, allowedPositions, need normalize pos', () => {
      const tooltip = new Tooltip({ allowedPositions: ['top', 'top right', 'bottom center'], pos: 'bottom' });
      tooltip.featureFlags = { popupUnifyPositioning: true };
      const positions = tooltip.getPositions();
    ...
    it('no flag, allowedPositions, need normalize pos', () => {
      ...
      tooltip.featureFlags = { popupUnifyPositioning: false };
      const positions = tooltip.getPositions();
      expect(positions).toEqual(['bottom center', 'top', 'top right']);
    });

    it('flag, allowedPositions, another pos', () => {
      const tooltip = new Tooltip({ allowedPositions: ['top', 'top right', 'bottom center'], pos: 'left middle' });
      tooltip.featureFlags = { popupUnifyPositioning: true };
      expect(() => tooltip.getPositions()).toThrow();
    });
    ...
    it('flag, need normalize allowedPositions, pos', () => {
      const tooltip = new Tooltip({ allowedPositions: ['top', 'top right', 'bottom center'], pos: 'top center' });
      tooltip.featureFlags = { popupUnifyPositioning: true };
      const positions = tooltip.getPositions();
      expect(positions).toEqual(['top', 'top right', 'bottom center']);
    });
