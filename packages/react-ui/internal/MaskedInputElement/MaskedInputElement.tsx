...
MaskedInputElement.__KONTUR_REACT_UI__ = 'MaskedInputElement';

const MaskedInputElementRefWrapper = forwardRef(MaskedInputElement);
export { MaskedInputElementRefWrapper as MaskedInputElement };
