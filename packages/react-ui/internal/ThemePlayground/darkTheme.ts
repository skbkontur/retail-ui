...
export const darkTheme = ThemeFactory.create({
  ...
  btnDefaultHoverBorderColor: 'rgba(0, 0, 0, 0.2) rgba(0, 0, 0, 0.2) rgba(0,0,0,0.32)',
  ...
  btnDefaultActiveBorderColor: 'rgba(0, 0, 0, 28) rgba(0, 0, 0, 0.2) rgba(0, 0, 0, 0.2)',
  ...
  btnSuccessBorderColor: 'rgba(25, 103, 6, 0.7) rgba(25, 103, 6, 0.7) rgba(23, 89, 7, 0.85)',
  btnSuccessShadowArrow: '1px 0 0 0 rgba(25, 103, 6, 0.7)',
  btnSuccessHoverBgStart: '#3b8d13',
  btnSuccessHoverBgEnd: '#317e0b',
  btnSuccessHoverShadow: 'none',
  btnSuccessHoverBorderColor:'rgba(7, 73, 1, 0.7) rgba(7, 73, 1, 0.7) rgba(10, 72, 2, 0.79)',
  ...
  btnSuccessActiveBorderColor:'rgba(7, 42, 3, 0.9) rgba(4, 63, 0, 0.75) rgba(4, 63, 0, 0.75) ',
  ...
  btnPrimaryBorderColor: 'rgba(14, 81, 129, 0.7) rgba(14, 81, 129, 0.7) rgba(10, 55, 100, 0.85) ',
  ...
  btnPrimaryHoverBorderColor: 'rgba(5, 60, 99, 0.7) rgba(5, 60, 99, 0.7) rgba(6, 51, 92, 0.79)',
  ...
  btnPrimaryActiveBorderColor: 'rgba(9, 53, 97, 0.88) rgba(10, 63, 99, 0.75) rgba(10, 63, 99, 0.75)',
  ...
  btnDangerBorderColor: 'rgba(173, 15, 0, 0.7) rgba(173, 15, 0, 0.7) rgba(89, 8, 0, 0.82)',
  btnDangerShadowArrow: '1px 0 0 0 rgba(173, 15, 0, 0.7)',
  btnDangerHoverBgStart: '#d44227',
  btnDangerHoverBgEnd: '#c73013',
  btnDangerHoverShadow: 'none',
  btnDangerHoverBorderColor: 'rgba(145, 0, 0, 0.7) rgba(145, 0, 0, 0.7) rgba(118, 1, 1, 0.82) ',
  ...
  btnDangerActiveBorderColor: 'rgba(100, 5, 5, 0.85) rgba(108, 7, 7, 0.75) rgba(108, 7, 7, 0.75)',
  btnDangerActiveShadowArrow: '1px 0 0 0 rgba(108, 7, 7, 0.75)',
  btnPayBg: '#ffc943',
  btnPayBgStart: '#ffd54b',
  btnPayBgEnd: '#ffbb39',
  btnPayShadow: 'none',
  btnPayBorderColor: 'rgba(238, 169, 34, 0.7) rgba(238, 169, 34, 0.7) rgba(134, 70, 12, 0.87)',
  btnPayShadowArrow: '1px 0 0 0 rgba(238, 169, 34, 0.7)',
  btnPayHoverBgStart: '#ffbd3a',
  btnPayHoverBgEnd: '#f8a91d',
  btnPayHoverShadow: 'none',
  btnPayHoverBorderColor: 'rgba(227, 142, 8, 0.7) rgba(227, 142, 8, 0.7) rgba(162, 82, 6, 0.82)',
  ...
  btnPayActiveBorderColor: 'rgba(99, 68, 0, 0.832) rgba(210, 144, 0, 0.7) rgba(210, 144, 0, 0.7)',
