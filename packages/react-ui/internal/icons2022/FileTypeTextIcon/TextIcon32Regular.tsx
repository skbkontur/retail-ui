...
export const TextIcon32Regular = forwardRefAndName<SVGSVGElement, IconProps>('TextIcon32Regular', (props, ref) => {
  return (
    <BaseIcon ref={ref} viewBoxSize={32} {...props}>
      <path d="M10 12C10 11.4477 10.4477 11 11 11H21C21.5523 11 22 11.4477 22 12C22 12.5523 21.5523 13 21 13H17V22C17 22.5523 16.5523 23 16 23C15.4477 23 15 22.5523 15 22V13H11C10.4477 13 10 12.5523 10 12Z" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
