...
import { DarkTheme5_5 } from './DarkTheme5_5';

export const DarkTheme5_6 = createTheme({
  themeClass: class DarkTheme5_6 extends BasicThemeClassForExtension {
