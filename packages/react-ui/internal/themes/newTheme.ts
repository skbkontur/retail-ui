...
export class NewTheme2022 extends (class {} as typeof DefaultThemeInternal) {
  ...
  public static errorMain = '#FE4C4C';
  ...
  public static btnIconGapMediumRight = '6px';

  public static btnIconGapLargeLeft = '8px';
  public static btnIconGapLargeRight = '8px';
  ...
  public static radioBulletSizeSmall = '8px';
  ...
  //#region RadioGroup
  public static radioGroupLegacyItemGap = '0px'; //TODO check if needed
  ...
  /**
   * @deprecated
   * use menuLegacyPaddingY
   */
  // public static internalMenuPaddingY = '5px'; // deprecated
...
export const NewTheme2022Internal = Object.setPrototypeOf(
  exposeGetters(NewTheme2022),
  DefaultThemeInternal,
) as typeof NewTheme2022;
