...
import { RenderEnvironmentContext } from './RenderEnvironmentContext';
...
export function withRenderEnvironment<T extends Constructor<React.Component>>(constructor: T) {
