...
| Имя                     | Описание                                          |
|-------------------------|---------------------------------------------------|
| `THEME_2022`            | Будет удалена в `5.0`                          |
| `DARK_THEME_2022`       | Будет удалена в `5.0`                   |
...
| `THEME_2022_UPDATE_2024`| Тема 2022 г. с последними обновлениями цветов. Станет дефолтной в `5.0`|
| `THEME_2022_UPDATE_2024`| Тёмная тема 2022 г. с последними обновлениями цветов. Станет дефолтной тёмной в `5.0`|
