...
Посмотреть, какие компоненты кастомизируются, а также увидеть, какие переменные используются в каждом из них, можно на странице [ThemePlayground](#/Customization/ThemePlayground). Там же можно построить свою тему и "вывести ее в консоль".
