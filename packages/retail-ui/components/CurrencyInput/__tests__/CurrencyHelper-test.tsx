...
describe('CurrencyHelper', () => {
  ...
  describe('isValidString', () => {
    [
      ...
      { value: '0123456789012345', integerDigits: null, fractionDigits: null, expected: false },
      { value: '1234567890123450', integerDigits: null, fractionDigits: null, expected: false },
      { value: '1234567890123456', integerDigits: null, fractionDigits: null, expected: false },

      { value: '123456789012345', integerDigits: null, fractionDigits: null, expected: true },
      { value: '.123456789012345', integerDigits: null, fractionDigits: null, expected: true },
      { value: '1234567.89012345', integerDigits: null, fractionDigits: null, expected: true },
      { value: '123456789012345.', integerDigits: null, fractionDigits: null, expected: true },

      { value: '123456789012345', integerDigits: null, fractionDigits: undefined, expected: true },
      { value: '123456789012345.', integerDigits: null, fractionDigits: undefined, expected: true },
      { value: '1234567.89012345', integerDigits: null, fractionDigits: undefined, expected: true },
      { value: '.123456789012345', integerDigits: null, fractionDigits: undefined, expected: true },

      { value: '123456789012345', integerDigits: null, fractionDigits: 0, expected: true },
      { value: '123456789012345.', integerDigits: null, fractionDigits: 0, expected: false },
      { value: '1234567.89012345', integerDigits: null, fractionDigits: 0, expected: false },

      { value: '12345678901234', integerDigits: null, fractionDigits: 1, expected: true },
      { value: '12345678901234.', integerDigits: null, fractionDigits: 1, expected: true },
      { value: '12345678901234.5', integerDigits: null, fractionDigits: 1, expected: true },
      { value: '123456789012345', integerDigits: null, fractionDigits: 1, expected: false },
      { value: '123456789012345.', integerDigits: null, fractionDigits: 1, expected: false },
      { value: '1234567890123.45', integerDigits: null, fractionDigits: 1, expected: false },
      { value: '1234567.89012345', integerDigits: null, fractionDigits: 1, expected: false },

      { value: '12345678901', integerDigits: undefined, fractionDigits: 4, expected: true },
      { value: '12345678901.', integerDigits: undefined, fractionDigits: 4, expected: true },
      { value: '12345678901.23', integerDigits: undefined, fractionDigits: 4, expected: true },
      { value: '12345678901.2345', integerDigits: undefined, fractionDigits: 4, expected: true },
      { value: '123456789012', integerDigits: undefined, fractionDigits: 4, expected: false },
      { value: '123456789012.', integerDigits: undefined, fractionDigits: 4, expected: false },
      { value: '1234567890123.', integerDigits: undefined, fractionDigits: 4, expected: false },
      { value: '123456789012345', integerDigits: undefined, fractionDigits: 4, expected: false },
      { value: '123456789012345.', integerDigits: undefined, fractionDigits: 4, expected: false },
      { value: '12345678901234.5', integerDigits: undefined, fractionDigits: 4, expected: false },
      { value: '1234567890123.45', integerDigits: undefined, fractionDigits: 4, expected: false },
      { value: '1234567890.12345', integerDigits: undefined, fractionDigits: 4, expected: false },

      { value: '12345678901.000', integerDigits: undefined, fractionDigits: 4, expected: true },
      { value: '12345678901.0000', integerDigits: undefined, fractionDigits: 4, expected: true },
      { value: '1234567890.00000', integerDigits: undefined, fractionDigits: 4, expected: false },

      { value: '', integerDigits: undefined, fractionDigits: null, expected: true },
      { value: '1', integerDigits: undefined, fractionDigits: null, expected: true },
      { value: '.', integerDigits: undefined, fractionDigits: null, expected: true },
      { value: ',', integerDigits: undefined, fractionDigits: null, expected: true },
      { value: '.1', integerDigits: undefined, fractionDigits: null, expected: true },
      { value: '1.', integerDigits: undefined, fractionDigits: null, expected: true },
      { value: '..', integerDigits: undefined, fractionDigits: null, expected: false },
      { value: '000.000', integerDigits: undefined, fractionDigits: null, expected: true },
      { value: '1 234 567 890 123,45', integerDigits: undefined, fractionDigits: null, expected: true },
      { value: '1 234 567 890 123,45', integerDigits: undefined, fractionDigits: 2, expected: true },

      { value: '', integerDigits: 0, fractionDigits: null, expected: true },
      { value: '0,12', integerDigits: 0, fractionDigits: null, expected: true },
      { value: '1,23', integerDigits: 0, fractionDigits: null, expected: false },
      { value: '1,23', integerDigits: 1, fractionDigits: null, expected: true },
      { value: '1,23', integerDigits: 2, fractionDigits: null, expected: true },
