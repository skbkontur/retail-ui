...
class StyledHint extends React.Component<HintProps, HintState> {
  ...
  private renderContent() {
    ...
    return (
      <StyledHintContent contentCenter={pos === 'top' || pos === 'bottom'} style={{ maxWidth }}>
        {this.props.text}
      </StyledHintContent>
    );
  }
