...
import Hint from '../StyledHint';
import Gapped from '../../Gapped';
import Input from '../../StyledInput';
import { PopupPositions } from '../../StyledPopup/StyledPopup';
...
storiesOf('StyledHint', module).add('Hints without wrapper around inline-block with 50% width', () => (
