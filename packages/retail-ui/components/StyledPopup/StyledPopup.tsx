...
import raf from 'raf';
import PopupHelper, { Offset, PositionObject, Rect } from '../Popup/PopupHelper';
import PopupPin from '../Popup/PopupPin';
import LayoutEvents from '../../lib/LayoutEvents';
import { Nullable } from '../../typings/utility-types';
import warning from 'warning';
import { FocusEventType, MouseEventType } from '../../typings/event-types';
import StyledZIndex from '../StyledZIndex/StyledZIndex';
import { StyledPopupContent, StyledPopupContentInner } from './StyledPopupView';
...
export default class StyledPopup extends React.Component<PopupProps, PopupState> {
      ...
      >
        {(state: string) => (
          <StyledZIndex
            ...
            ignoreHover={this.props.ignoreHover}
          ...
          >
            <StyledPopupContent>
              <StyledPopupContentInner style={{ backgroundColor }}>{this.renderChildren()}</StyledPopupContentInner>
            </StyledPopupContent>
  ...
  private refPopupElement = (zIndex: StyledZIndex | null) => {
    if (zIndex) {
  ...
  private renderPin(position: string): React.ReactNode {
     ...
     * shadow to pin too.
     */
    const pinBorder = POPUP_BORDER_DEFAULT_COLOR;
