...
import { TooltipContent, TooltipCross } from './StyledTooltipView';
...
class Tooltip extends React.Component<TooltipProps, TooltipState> {
  ...
  public renderContent = () => {
    ...
    return (
      <TooltipContent ref={this.refContent}>
        {content}
  ...
  public renderCloseButton() {
    ...
    return <TooltipCross onClick={this.handleCloseButtonClick}>{CROSS}</TooltipCross>;
  }
