...
describe('MaskedInput', () => {
  ...
  it.each([
    ...
    const wrapper = mount(
      <MaskedInput alwaysShowMask maskChar="_" mask={mask} />
    );
  ...
  it.each([
    ...
    'Mask %s - pass value %s - state value %s',
    (mask, inputValue, expectedValue) => {
      const wrapper = mount(
        <MaskedInput value={inputValue} maskChar="_" mask={mask} />
      );
