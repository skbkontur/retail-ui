...
import { InputState } from '../../themes/default/input';
...
export const InputLeftIcon = InputIcon.extend`
  left: 0;
  padding-left: ${({ theme }) => theme.input.padding};
`;

export const InputRightIcon = InputIcon.extend`
  right: 0;
...
export const InputStyledView = styled(InputView)`
  ...
  padding-left: ${props =>
    props.hasLeftIcon ? props.theme.input.iconWidth : props.theme.input.padding};
    padding-right: ${props =>
      props.hasRightIcon ? props.theme.input.iconWidth : props.theme.input.padding};
